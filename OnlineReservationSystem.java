...
public class OnlineReservationSystem {
    ...
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in); // Create a single Scanner instance2
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 2:
                    reserveSeat(scanner); // Pass the scanner to the method
                    break;

                case 3:
                    cancelReservation(scanner); // Pass the scanner to the method
                    break;
    ...
    private static void reserveSeat(Scanner scanner) { // Use the scanner passed as a parameter
    ...
    private static void cancelReservation(Scanner scanner) { // Use the scanner passed as a parameter
        System.out.print("\nEnter seat number (1-10): ");
        int seatNumber = scanner.nextInt();
        if (seatNumber < 1 || seatNumber > 10) {
            System.out.println("Invalid seat number!");
